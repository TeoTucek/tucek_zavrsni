...
<head>
    ...
    <!-- STIL ZA BUBBLE EFEKAT (DODAJ OVO) -->
    <style>
        /* Dodatni stil za bubble efekat - da ne smeta klikovima */
        .bubble-effect {
            position: fixed;
            pointer-events: none;
            z-index: 9999;
            ...
            <form method="POST" action="spremi.php" id="rezervacijaForma">
                ...
                <div class="form-group">
                    ...
                    <select name="id_lokacije" id="lokacija" required>
                        ...
                        <option value="<?php echo $l['id_lokacije']; ?>" 
                                data-kapacitet="<?php echo $l['kapacitet']; ?>">
                ...
                <div class="usluge-box">
                    ...
                    <div id="ukupnoUslugeContainer" class="usluge-ukupno-container">
                        <table class="usluge-tablica">
                            <thead><tr><th>Usluga</th><th>Cijena</th><th>Količina</th><th>Ukupno</th></tr></thead>
...
<script>
    ...
    function azurirajInfoBox(jeOtok) {
        if (jeOtok) {
            $(".info-r23").hide();
            $(".info-otok").show();
        } else {
    ...
    $(document).ready(function() {
        ...
        $("#rezervacijaForma").submit(function(e) {
            if (!$("#lokacija").val() || !$("#datum").val() || !$("#tipUlaznice").val() || !$("input[name='ime']").val() || !$("input[name='mobitel']").val()) {
